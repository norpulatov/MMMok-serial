...
- Admin panel:
  ...
  - forced subscription management (on/off + multiple channels)
- Forced subscription middleware:
  - when enabled, users must join all required channels before using bot
...
FOYDAADS_API_KEY=your_foydaads_api_key
# or API_KEY=your_foydaads_api_key
```
