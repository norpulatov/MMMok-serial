...
def get_settings() -> Settings:
    ...
    if not bot_token:
        raise ValueError('BOT_TOKEN (yoki TELEGRAM_BOT_TOKEN) .env da bo\'lishi shart.')
    ...
    return Settings(
        ...
        foydaads_api_key=os.getenv('FOYDAADS_API_KEY', '').strip() or os.getenv('API_KEY', '').strip(),
    )
